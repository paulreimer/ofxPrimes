...
//---------------------------------------------------------------------
ofxSimpleGuiQuadWarp::ofxSimpleGuiQuadWarp(string name, float x, float y, float sw, float sh, ofPoint **inpts)
...
//---------------------------------------------------------------------
void
ofxSimpleGuiQuadWarp::mousePressed(int x, int y, int button)
{
	mouse.set(x, y);
...
//---------------------------------------------------------------------
void
ofxSimpleGuiQuadWarp::mouseDragged(int x, int y, int button)
{
	mouse.set(x, y);
	if(checkDistanceToPoint()) {
...
//---------------------------------------------------------------------
void
ofxSimpleGuiQuadWarp::mouseReleased()
{
	mouseOn = false;
	onPnt = 6;
}
...
//---------------------------------------------------------------------
void
ofxSimpleGuiQuadWarp::drawWidget(float x, float y)
{
	setPos(x, y);
	glPushMatrix();
	glTranslatef(x, y, 0);
