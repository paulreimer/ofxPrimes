...
public:
	...
	void findFiducials(unsigned char* pixels, unsigned int w, unsigned int h);
	void findFiducials(ofImage& image);
	...
	ofPoint getVideoSize() { return ofPoint(m_width, m_height); }
private:
